...
export const Main = () => {
	...
	function getResult(genre) {
		// const updatedTodo = todo.filter((i) => i.nameG === genre);
		const updatedTodo = genre === "" ? data : data.filter((i) => i.nameG === genre)
		setTodo(updatedTodo);
	}

	const changeGenre = (e) => {	
		const selecteGenre = e.target.innerText
		setGenre(selecteGenre);
		getResult(selecteGenre);
	};
	return (
...
// 	  getResult(selectedGenre);
// 	};
  
// 	return (
// 	  <div className="container">
// 		<div className="paddContent">
// 		  <form className="ulers"></form>
// 		  <div className="contentButtons">
// 			<Button text="Фантастика" style="buttonG" onClick={changeGenre} />
// 			<Button text="Любовь" style="buttonG" onClick={changeGenre} />
// 			<Button text="мультики" style="buttonG" onClick={changeGenre} />
